...
public class Task5 {
	public static void main(String[] args) throws InterruptedException, IOException {
		...
		WebElement txt = driver.findElement(By.id("heading2011"));
		...
		File f=new File("C:\\Eclipse\\Task5.png");
		
		FileUtils.copyFile(fl, f);
	
		WebElement txt1 = driver.findElement(By.xpath("//h3[text()='Online Classroom']"));
		js.executeScript("arguments[0].scrollIntoView(false)",txt1);
